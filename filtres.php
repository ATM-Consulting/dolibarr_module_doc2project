...
function _print_filtre_customer_management(&$formcore){
	...
	print '<table>';
	print '<tr>
				<td colspan="2"><b>Cloture du devis</b></td>
				<td colspan="2"><b>Réception des enquetes</b></td>
				<td colspan="2"><b>Réalisation des essais</b></td>
		   </tr>';
	print '<tr>';
    ...
    print '<tr>
    			<td colspan="2" align="center">'.$formcore->btsubmit('Valider', '').'</td>
    	   </tr>';
