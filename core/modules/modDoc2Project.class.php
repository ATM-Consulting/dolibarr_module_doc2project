...
class modDoc2Project extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		*/
		...
		//							'langs'=>'mylangfile@doc2project',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'isModEnabled('doc2project')',  // Define condition to show or hide menu entry. Use 'isModEnabled('doc2project')' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
