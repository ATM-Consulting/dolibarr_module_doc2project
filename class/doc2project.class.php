...
//var_dump($defaultref, $label,  $project->id);exit;		
		self::createOneTask( $project->id, $line->rowid, $object->element, $label, $line->desc, $start, $end, $fk_task_parent, $durationInSec, $line->total_ht,$fk_workstation,$line,$story);
...
//var_dump($object->lines);exit;		
	...
	public static function createOneTask($fk_project, $fk_origin, $origin_type, $label='', $desc='', $start='', $end='', $fk_task_parent=0, $planned_workload='', $total_ht='', $fk_workstation = 0,$line='',$story='')
	{
		global $conf,$langs,$db,$user,$hookmanager;
